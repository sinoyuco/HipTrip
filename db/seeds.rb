...
a1 = Spot.create!(name: 'Red Rock Retreat', price: 100, city:'Golden', state: 'Colorado', latitude: 39.7555, longitude: -105.2211, category: 'RVs', host_id: user1.id, image_url: 'https://d2umhuunwbec1r.cloudfront.net/gallery/parks/default-features/featureTwo/red-rock.jpg', description: "Ever heard of the famous Red Rocks of Colorado? We offer you an up close look at the Red Rock Retreat. Bring your RV to experience the best outdoors Colorado has to offer, with plenty of activities and sights to see.")
...
a5 = Spot.create!(name: 'Reliable Residence', price: 60, city:'Austin', state: 'Texas', latitude: 30.179659, longitude: -97.991176, category: 'Camping', host_id: user2.id, image_url: 'https://houseofbrokersrealty.files.wordpress.com/2013/11/66.jpg', description: "Reliable Residence offers one thing, and you guessed it right: Reliability. Don't expect grandiose camping accomodations or flashy activities. Electricity is working, water is running, prices are reasonable, and you might be able to fit a tent in the backyard.")
