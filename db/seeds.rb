...
a10 = Spot.create!(name: 'Perilous Palace', price: 500, city:'Atlanta', state: 'Georgia', latitude: 33.767346, longitude: -84.422487, category: 'RV Park', host_id: user3.id, image_url: 'https://cdn.getyourguide.com/img/tour_img-3085250-148.jpg', description: 'The term camp comes from the Latin word campus, meaning \'field\'. Therefore, a campground consists typically of open pieces of ground where a camper can pitch a tent or park a camper. More specifically a campsite is a dedicated area set aside for camping and for which often a user fee is charged. Campsites typically feature a few (but sometimes no) improvements.')
