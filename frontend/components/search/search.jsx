                            ...
                            <ul className="category-dropdown">
                                <li onClick={this.handleTypeClick('All Camping')}>
                                    <div className="category-dropdown-left">
                                        {this.state.type === 'All Camping' ? <i class="fas fa-check"></i> : null}
                                    </div>
                                ...
                                <li onClick={this.handleTypeClick('Camping')}>
                                    <div className="category-dropdown-left">
                                        {this.state.type === 'Camping' ? <i class="fas fa-check"></i> : null}
                                    </div>
                                ...
                                <li onClick={this.handleTypeClick('Glamping')}>
                                    <div className="category-dropdown-left">
                                        {this.state.type === 'Glamping' ? <i class="fas fa-check"></i> : null}
                                    </div>
                                ...
                                <li onClick={this.handleTypeClick('RVs')}>
                                    <div className="category-dropdown-left">
                                        {this.state.type === 'RVs' ? <i class="fas fa-check"></i> : null}
                                    </div>
